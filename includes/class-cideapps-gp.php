...
class Cideapps_Gp {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/custom-taxonomies/class-Plugin-perzonalizado-taxonomies.php';
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/custom-post-types/class-equipo-post-type.php';
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/custom-post-types/class-proyectos-post-type.php';
