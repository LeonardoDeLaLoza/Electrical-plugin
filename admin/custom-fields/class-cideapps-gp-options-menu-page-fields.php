...
class Cideapps_Gp_Options_Menu_Page_Fields {
    ...
    function menu_page_metabox() {
        ...
        // E-mail-2.
        $cagp_metabox->add_field( array(
            'name' => esc_html__( 'Contact e-mail 2', 'cideapps-gp' ),
            'desc' => esc_html__( 'Add your second corporate email (optional)', 'cideapps-gp' ),
            'id'   => 'contact_email_2',
            'type' => 'text_email',
        ) );
        ...
        $cagp_metabox->add_field( array(
         ...
         // Linkedln.
        $cagp_metabox->add_field( array(
            'name' => esc_html__( 'Linkedln', 'cideapps-gp' ),
            'desc' => esc_html__( 'Add your Linkedln profile URL', 'cideapps-gp' ),
            'id'   => 'linkedln_url',
            'type' => 'text_url',
            'protocols' => array( 'https' ),
        ) );
